...
namespace cSharp_basic_homework_1
{
	public partial class Dialog
	{
		...
		protected virtual void Build()
		{
			...
			// Widget cSharp_basic_homework_1.Dialog
			this.Name = "cSharp_basic_homework_1.Dialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child cSharp_basic_homework_1.Dialog.VBox
			...
			this.textview1.Buffer.Text = "{Problems.One()}";
			...
			w3.Position = 0;
			// Internal child cSharp_basic_homework_1.Dialog.ActionArea
